...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('system_settings', function (Blueprint $table) {
            ...
            $table->text('landing_services_description');
            $table->text('landing_branches_description');
            $table->text('landing_contact_description');
            $table->string('business_email')->default('clinic@example.com');
            $table->string('landing_cta_title')->default('Ready to care for your skin?');
            $table->text('landing_cta_description');
